...
var biodiversityText = "<h1>Biodiversity</h1><p>The DRC is home to five natural <strong>World Heritage Sites</strong>, hosting a level of biodiversity unparalled in Africa.  The mountains of the <span class='navigate'>Arlbertine Rift</span>, along the country's eastern boarder, are home to more endemic species than any other region in Africa.  The volcanic and seismic activity that created this massif also generated the region's significant mineral and oil reserves.  Although mineral concession owners hold the rights to much of the region's mineral wealth, instability means that most of these reserves are mined by local <strong>artisanal miners</strong> whose livelihood depends on the small wages paid.</p><h1>Biodiversity and Extractives</h1><p>[insert text on oil exploration concessions along the lakes of the Albertine Rift]</p>";
