...
#intermediaries {
  ...
  marker-allow-overlap:true;  
  marker-line-color: #f64;
  [zoom <= 2]{ marker-width:@s1_width; marker-line-width:0.1; }
  [zoom = 3]{ marker-width:@s1_width * @3; marker-line-width:0.2; }
  [zoom = 4]{ marker-width:@s1_width * @4; marker-line-width:0.4; }
  [zoom = 5]{ marker-width:@s1_width * @5; marker-line-width:0.6; }
  [zoom = 6]{ marker-width:@s1_width * @6; marker-line-width:0.8; }
  [zoom = 7]{ marker-width:@s1_width * @7; marker-line-width:1.3; }
  [zoom = 8]{ marker-width:@s1_width * @8; marker-line-width:1.6; }
  [zoom >= 9]{ marker-width:@s1_width * @9; marker-line-width:2; }
  marker-opacity: 0;
}
